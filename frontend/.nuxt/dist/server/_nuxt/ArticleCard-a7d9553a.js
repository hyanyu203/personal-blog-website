...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span data-v-3736283c>${ssrInterpolate(_ctx.article.readingMinutes)} 分钟 · ${ssrInterpolate(_ctx.article.viewCount)} 阅读</span><!--[-->`);
...
const ArticleCard_vue_vue_type_style_index_0_scoped_3736283c_lang = "";
...
//# sourceMappingURL=ArticleCard-a7d9553a.js.map
